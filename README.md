...
มีสวิตช์ `Auto Remove` เพื่อเปิดให้ลบจุดไข่ปลาในทุกข้อความโดยอัตโนมัติ (เปิดแล้วจะลบทั้งบทสนทนาที่มีอยู่ทันทีและจะตรวจสอบทุกครั้งที่มีการส่งข้อความหรือได้รับข้อความใหม่)
